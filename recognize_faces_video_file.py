...
# Following function needs path to input file, encoding file and writes processed video in path to output file
def recognise_video(
    encoding_file, input_path, output_path, detection_method="hog", display=True
):
